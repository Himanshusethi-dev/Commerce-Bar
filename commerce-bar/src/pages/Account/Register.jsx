...
const Register = () => {
    ...
    const createCustomerTrigger = async (evt) => {
        ...
        try {
            const {data} = await createCustomer(registerData);
            ...
            if(data.data.customerCreate.customerUserErrors.length === 0){
                ...
                // console.log("message",data.data.customerCreate.customerUserError[0].message);
                alert(data.data.customerCreate.customerUserErrors[0].message);
            }

            // console.log("message",data.data.customerCreate.customerUserErrors[0].message);
        } catch (error) {
        }
        ...
        <div className="container">
{
            ...
            <div className='successMessage'> Hurray,Your account is created </div>)
